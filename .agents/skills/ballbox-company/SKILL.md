...
1. Use the Ballbox namespace at `/mnt/rpi/repos/personal-agent/ballbox-company-agent` as the working context root.
2. Read `/mnt/rpi/repos/personal-agent/ballbox-company-agent/AGENTS.md` and follow its rules.
3. Use `/mnt/rpi/repos/personal-agent/ballbox-company-agent/index.md` as the default dashboard entry point.
